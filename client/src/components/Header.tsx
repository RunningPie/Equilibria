 ...
 */
// Navigation menu items configuration (base items)
const baseNavItems = [
...
export function Header() {
  ...
  // Filter navigation items based on user group assignment
  const navItems = baseNavItems.filter(item => {
    if (item.path === '/peer-hub') {
      return user?.group_assignment === 'A';
    }
    return true;
  });
