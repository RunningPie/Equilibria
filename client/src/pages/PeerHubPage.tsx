      ...
      <div className="bg-white rounded-lg max-w-lg w-full">
        ...
        <div className="p-6 border-t border-gray-200 flex justify-end gap-3">
          ...
          <button
            onClick={() => onRate(true)}
            disabled={isSubmitting}
            className="px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 disabled:opacity-50 transition-colors flex items-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      {item.status === 'PENDING_REVIEW' && (
                        <button
                          onClick={() => setReviewModalSession(item.session_id)}
                          className="bg-purple-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-purple-700 transition-colors ml-4"
                        >
                          Write Review
                        </button>
                      )}
