...
| CH01-Q016 | Fakultas sedang mempertimbangkan untuk menggandakan SKS mata kuliah tertentu. Coba tampilin kode matkul, SKS lama, dan SKS baru kalau SKS mata kuliah yang ada dikali 2. Kasih alias `double_credits` biar jelas! | 1225 | `SELECT course_id, credits, (credits * 2) AS double_credits FROM course;` |
