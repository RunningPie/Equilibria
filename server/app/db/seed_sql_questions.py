...
QUESTIONS_DATA = [
    ...
    },
    {
        ...
        "module_id": "CH01",
        "content": "Coba tunjukin nama dan departemen dosen dengan gaji antara 60rb dan 90rb? jangan lupa cek yang salary-nya nggak NULL ya!",
        "target_query": "SELECT name, dept_name FROM instructor WHERE salary BETWEEN 60000 AND 90000 AND salary IS NOT NULL;",
    ...
    },
    {
        ...
        "module_id": "CH01",
        "content": "Tolong tampilkan kombinasi nama building dan room_no yang unik dong.",
    ...
    #     "module_id": "CH01",
    #     "content": "Rudi penasaran siapa saja mahasiswa yang namanya setidaknya mengandung 2 kata (berarti ada spasi) dan berakhiran huruf 'n'. Tampilkan hanya nama dan departemennya!",
    #     "target_query": "SELECT name, dept_name FROM student WHERE name LIKE '% %' AND name LIKE '%n';",
    ...
    #     "module_id": "CH01",
    #     "content": "Coba cari judul mata kuliah yang TIDAK mengandung kata 'Intro' di judulnya dan SKS-nya <= 3.",
    #     "target_query": "SELECT title FROM course WHERE title NOT LIKE '%Intro%' AND credits <= 3;",
    ...
    #     "module_id": "CH01",
    #     "content": "Kampus sedang mau liat daftar nama dosen dan ID mata kuliah yang mereka ajar. Bisa bantu cariin? Tolong diurutkan berdasarkan nama dosen ASC dan course_id ASC",
