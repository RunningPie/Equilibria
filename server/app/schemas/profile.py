...
class ProfileStats(BaseModel):
    ...
    """
    theta_individu: float = Field(..., example=1300.0, description="Individual Elo rating [1000, 1800]")
    theta_social: float = Field(..., example=1300.0, description="Social Elo rating [1000, 1800]")
